...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const response = await fetch(`https://eco-urban.onrender.com/users`);
  ...
  const changeUserStatus = async (userId, newStatus) => {
    ...
    try {
      const response = await fetch(`https://eco-urban.onrender.com/users/update-status`, {
        method: 'POST',
  ...
  const deleteUser = async (userId) => {
    try {
      const response = await fetch(`https://eco-urban.onrender.com/users/${userId}`, {
        method: 'DELETE',
      });
